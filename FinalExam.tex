...
\begin{solution}
  \begin{align*}
    u(x,t) &= \int_{-\infty}^{\infty}\hat{u}(\omega,t)e^{i\omega t}d\omega \\
           &= \int_{-\infty}^{\infty}\bigg[\frac{1}{4\pi}e^{-i\omega s}\bigg(e^{\sqrt{\omega^2-1}t}+
             e^{-\sqrt{\omega^2-1}t} \bigg) \bigg]e^{i\omega t}d\omega \\
           &= \frac{1}{4\pi}\int_{-\infty}^{\infty}\bigg[e^{-i\omega s}\bigg(e^{\sqrt{\omega^2-1}t}+
             e^{-\sqrt{\omega^2-1}t} \bigg) \bigg]e^{i\omega t}d\omega \\
           &= \frac{1}{4\pi}\int_{-\infty}^{\infty}\bigg(e^{\sqrt{\omega^2-1}t}+
             e^{-\sqrt{\omega^2-1}t} \bigg)e^{i\omega (t-s)}d\omega \\
